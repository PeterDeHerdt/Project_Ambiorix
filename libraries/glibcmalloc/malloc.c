...
#define public_mSTATs    _malloc_stats
...
#include <malloc.h>
// Hack to cope with otudated toolchain headers:
#ifndef M_PERTURB
#define M_PERTURB -6
#endif
...
void weak_variable (* __MALLOC_HOOK_VOLATILE __malloc_initialize_hook) (void) = NULL;
void weak_variable (* __MALLOC_HOOK_VOLATILE __free_hook) (__malloc_ptr_t __ptr,
				   const __malloc_ptr_t) = NULL;
__malloc_ptr_t weak_variable (*__MALLOC_HOOK_VOLATILE __malloc_hook)
     (size_t __size, const __malloc_ptr_t) = malloc_hook_ini;
__malloc_ptr_t weak_variable (* __MALLOC_HOOK_VOLATILE __realloc_hook)
     (__malloc_ptr_t __ptr, size_t __size, const __malloc_ptr_t)
     = realloc_hook_ini;
__malloc_ptr_t weak_variable (*__MALLOC_HOOK_VOLATILE __memalign_hook)
     (size_t __alignment, size_t __size, const __malloc_ptr_t)
     = memalign_hook_ini;
void weak_variable (* __MALLOC_HOOK_VOLATILE __after_morecore_hook) (void) = NULL;
...
weak_alias (__malloc_stats, _malloc_stats)
...
malloc_printerr(int action, const char *str, void *ptr)
{
  if ((action & 5) == 5)
    ...
    {
      fprintf(stderr, "*** glibc detected *** %s: 0x%p ***\n", str, ptr);
    }
  else if (action & 2)
    abort ();
}
